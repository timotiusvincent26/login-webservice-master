...
<div class="w-screen h-screen sm:grid sm:grid-cols-2 sm:gap-0 md:gap-12 py-0 px-8 xl:gap-32 lg:gap-24">
    <div class="sm:flex justify-end items-center hidden">
        <img src="/img/login.svg" alt="login" style="width: 70%;">
    </div>
    <div class="flex justify-center items-center mt-28">
        <form style="width: 70%;" method="POST" action="/login/masuk" class="bg-gray-200 py-8 rounded-3xl shadow-2xl transform translate-y-48 sm:translate-y-0">
            <?= csrf_field(); ?>
            <h2 class="text-2xl text-center font-bold mb-2">LOGIN USER</h2>
            ...
            <div class="flex justify-center my-4">
                <input type="submit" class="shadow-2xl block h-10 px-32 sm:px-24 md:px-32 lg:px-32 rounded-3xl text-lg outline-none border-none bg-blue-600 cursor-pointer text-gray-300 duration-500 uppercase hover:bg-blue-700 mx-6" value="Login">
            </div>
            ...
            <div class="flex justify-center mt-4 mb-4">
                <div class="bg-gray-400 flex justify-center py-1 rounded-full w-64 transform hover:scale-105 shadow-2xl duration-300 hover:bg-gray-200">
                    <a href="/login/loginsipadu" class="flex w-64 items-center cursor-pointer justify-center hover:text-blue-600">
                        <div class="flex justify-center items-center text-center">
                            <img src="/img/logo.png" alt="sipadu" width="32" height="32" class="mr-4">
                            <span>Login with SIPADU</span>
                        </div>
                    </a>
                </div>
            </div>
            <div class="flex justify-center">
                <div class="bg-gray-400 flex justify-center py-1 rounded-full w-64 transform hover:scale-105 shadow-2xl duration-300 hover:bg-gray-200">
                    <a href="" class="flex w-64 items-center cursor-pointer justify-center hover:text-blue-600">
                        <div class="flex justify-center items-center text-center">
                            <img src="/img/google.png" alt="google" width="32" height="32" class="mr-4">
